...
class MovieInfoRepositoryIntgTest {
    ...
    void setUp() {
        ...
        movieInfoRepository.saveAll(movieinfos)
                .blockLast(); // Hace esperar hasta que el bloque se complete
    }
    ...
    void saveMovieInfo() {
        ...
        StepVerifier.create(moviesInfoMono)
                //.expectNextCount(1)
                .assertNext(movieInfoMono -> {
                    assertNotNull(movieInfoMono.getMovieInfoId());
                    assertEquals("Batman Begins", movieInfoMono.getName());
                })
                .verifyComplete();
    }
